  ...
  <div class="container mt-5">
    <div class="card shadow mt-4">
      ...
      if ($ggl) {
        ...
        $det = mysqli_query($conn, "select * from data_bulan where id='$id_brg'") or die(mysql_error());
          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-5 col-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <a href="bulan.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                  </div>
                  <div class="col-md-8">
