  ...
  <div class="container mt-5">
    <div class="card shadow mt-4">
      ...
      if ($ggl) {
        ...
        $det = mysqli_query($conn, "SELECT data_minggu.*, users.username 
                FROM data_minggu
                JOIN users ON users.id = data_minggu.user_id 
                WHERE data_minggu.id='$id_brg'") 
          ...
          <div class="row mt-5">
            ...
            <div class="col-xl-5 col-lg-5">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <a href="minggu.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
                  </div>
                  <div class="col-md-8">
